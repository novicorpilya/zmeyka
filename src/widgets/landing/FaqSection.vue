...
const faqItems = [
  {
    ...
    a: 'Наша платформа оптимизирована для школьников от 10 до 16 лет. Темы и сложность задач автоматически подстраиваются под возраст и текущие знания ребенка.',
    tags: ['Возраст', '10-16 лет'],
  },
  {
    q: 'Нужны ли начальные знания программирования?',
    a: 'Нет, мы начинаем с самых азов. ИИ-наставник поможет сделать первые шаги, объясняя сложные термины простыми словами и наглядными примерами.',
    tags: ['Для новичков', 'Старт'],
  },
  {
    q: 'Как ИИ помогает в обучении?',
    a: 'Система мгновенно проверяет написанный код, указывает на ошибки и, самое главное, объясняет, почему возникла ошибка и как её исправить, не давая при этом готовых ответов.',
    tags: ['ИИ', 'Технологии'],
  },
  {
    q: 'Можно ли учиться с телефона или планшета?',
    a: 'Да, наш редактор кода и все уроки полностью адаптированы для мобильных устройств. Ребенок может учиться в любое удобное время, даже в дороге.',
    tags: ['Устройства', 'Мобильность'],
  },
  {
    q: 'Будет ли у ребенка сертификат по окончании?',
    a: 'После прохождения базового и продвинутых курсов генерируется персональный сертификат, который можно добавить в портфолио или показать в школе.',
    tags: ['Сертификат', 'Карьера'],
  },
]
